	...
	$('.cms-grid-wraper').each(function(){
		...
		if(typeof cms_variable != 'undefined'){
			...
			if(pageNum[html_id] <= max[html_id]) {
				...
				$('#'+html_id +' .cms_pagination').append('<div class="cms-placeholder-'+ pageNum[html_id] +'"></div><p class="cms-load-posts"><a data-loading="0" href="#" class="wpb_button_anone wpb_none btn btn-default">'+text+'</a></p>');
			}
