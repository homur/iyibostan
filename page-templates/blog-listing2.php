...
?>
<div id="page-blog-listing" class="page-blog-listing2 <?php if (wp_organic_sidebar_left_active()) { echo 'sidebar-left-active'; } ?>">
    <div class="container">
        <div class="row">
