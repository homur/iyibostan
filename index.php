                        ...
                        <article id="post-0" class="post no-results not-found">
                            ...
                            <?php if ( current_user_can( 'edit_posts' ) ) :
                                ...
                                <header class="entry-header">
                                    <h1 class="entry-title"><?php esc_html_e( 'No posts to display', 'wp-organic' ); ?></h1>
                                </header>

                                <div class="entry-content">
                                    <p><?php printf( esc_html__( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'wp-organic' ), admin_url( 'post-new.php' ) ); ?></p>
                                </div><!-- .entry-content -->
                            ...
                            <?php else :
                                ...
                                <div class="entry-content">
                                    <p><?php esc_html_e( 'Apologies, but no results were found. Perhaps searching will help find a related post.', 'wp-organic' ); ?></p>
                                    <?php get_search_form(); ?>
                                </div><!-- .entry-content -->
