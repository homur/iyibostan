    ...
    <?php if($atts['filter']=="true" and $atts['layout']=='masonry'):?>
        <div class="cms-grid-filter">
            <ul class="cms-filter-category list-unstyled list-inline">
                <li class="all_cat"><a class="active custom-font-3" href="#" data-group="all"><span><?php echo esc_html__('All products', 'wp-organic');?></span></a></li>
...
<div class="view-all">
    <a class="custom-font-3" href="<?php echo esc_url(home_url('/').'?post_type=product'); ?>">
        <?php echo esc_html__('View all product', 'wp-organic');?>
    </a>
</div>
</div>