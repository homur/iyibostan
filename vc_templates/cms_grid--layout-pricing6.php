<div class="cms-grid-wraper cms-pricing-layout6 <?php echo esc_attr($atts['template']);?> clearfix" id="<?php echo esc_attr($atts['html_id']);?>">
            ...
            <div class="cms-pricing-item <?php if($pricing_feature) { echo " pricing-feature";} ?> <?php echo esc_attr($atts['item_class']);?>">
                <div class="cms-grid-title">
                    <div class="cms-pricing-title">
                       <h3 class="custom-font-11"><?php the_title();?></h3>
                    </div>
                ...
                <div class="cms-grid-content">
                    ...
                    <div class="cms-ordernow">
                        <a class="btn btn-primary custom-font-11" href="<?php echo esc_url($pricing_btn_link);?>"><?php echo esc_attr(
                        $pricing_btn_text);?></a>
                    </div>
                </div>
            </div>
