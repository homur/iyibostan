<div style="opacity: 0;" class="cms-carousel layout-attorney attorney-layout1 cms-carousel-attorney-layout1 cms_carousel--layout-team1 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php
    $posts = $atts['posts'];
    $size = 'full';
        ...
        <div class="cms-carousel-item cms-team-item">
            <?php 
                if(has_post_thumbnail() && !post_password_required() && !is_attachment() &&  wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), $size, false)):
                    ...
                    $thumbnail = get_the_post_thumbnail(get_the_ID(),'wp_organic_portfolio-2height');
                else:
                    $class = ' no-image';
            ...
            <div class="cms-grid-team-content">
                <div class="description">
                    <?php echo substr(get_the_content(), 0,90); ?>
                </div>
