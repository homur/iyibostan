<div style="opacity: 0;" class="cms-carousel layout-attorney attorney-layout1 cms-carousel-attorney-layout1 cms_carousel--layout-team2 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php
    $posts = $atts['posts'];
    $size = 'full';
        ...
        <div class="cms-carousel-item cms-team-item">
            ...
            <div class="cms-grid-team-content">
                <div class="description">
                    <?php
                    wp_organic_the_excerpt(92, '', esc_html__('...', 'wp-organic'));
                     ?>
                </div>
