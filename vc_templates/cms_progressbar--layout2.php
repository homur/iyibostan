...
?>
<div class="cms-progress-wraper cms-progress-layout2 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
                ...
                <div class="progress-content">
                    ...
                    <div class="cms-progress progress<?php if($vertical){ echo ' vertical bottom'; } ?> <?php if($striped){echo ' progress-striped';}?>"
                        ...
                        <div id="item-<?php echo esc_attr($atts['html_id']); ?>"
                             ...
                             style="background-color:<?php echo esc_attr($color);?>; border-radius:calc(<?php echo esc_attr($border_radius);?> / 2);height:calc(<?php echo esc_attr($height);?> / 2);margin-top:calc(<?php echo esc_attr($height);?> / 4)"
                            >
                        </div>
                    </div>
                </div>
